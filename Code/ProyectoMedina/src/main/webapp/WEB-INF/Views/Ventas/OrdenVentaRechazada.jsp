<%-- 
    Document   : OrdenVentaRechazada
    Created on : 13/11/2014, 03:36:56 PM
    Author     : Salvadorjr
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                <spring:message code="rechazadas"></spring:message>Rechazadas
                            </h1>                        
                        </div>
                    </div>    
                                    ...
                                    <table class="table table-bordered ">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><spring:message code="rechazo"></spring:message>Rechazó</th>
                                                <th><spring:message code="fechaalta"></spring:message>Fecha Alta</th>
                                                <th><spring:message code="fecharechazo "></spring:message>Fecha Rechazo</th>
