<%-- 
    Document   : ReportePorDia
    Created on : 13/11/2014, 03:35:33 PM
    Author     : Salvadorjr
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                               <spring:message code="pordia"></spring:message> Por día
                            </h1>                        
                        </div>
                    </div>        
                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 text-left">
                                                    <div class="form-group" align="left">
                                                        <label><spring:message code="cortede"></spring:message>Corte de</label>
                                                        ...
                                                        <div class="form-group" align="left">
                                                            <label><spring:message code="deldia"></spring:message>Del dia </label><input class="form-control" type="date" min="2014-10-28" name="fecha"  id="fecha"> &nbsp;
                                                        </div>
                                                    </div> 
                                                </div> 
                                            </div>
