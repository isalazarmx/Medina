<%-- 
    Document   : OrdenVentaPendiente
    Created on : 13/11/2014, 03:37:29 PM
    Author     : Salvadorjr
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                               <spring:message code="porevaluar"></spring:message> Por evaluar
                            </h1>                        
                        </div>
                    </div>    
                                    ...
                                    <table class="table table-bordered ">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><spring:message code="vendedor"></spring:message>Vendedor</th>
                                        ...
                                        <tbody>
                                            <tr class="success">
                                                ...
                                                <td>17/10/2014</td>
                                                <td class="text-center"><a class='btn btn-success btn-xs' href="#"><spring:message code="aceptar"></spring:message>Aceptar</a> &nbsp<a class='btn btn-danger btn-xs' href="#"><spring:message code="rechazar "></spring:message>Rechazar</a>&nbsp<a class='btn btn-primary btn-xs' href="#"><spring:message code="detalles"></spring:message>Detalles</a></td>
                                            </tr>
                                            <!--                                         <tr class="info">
                                                                                        <td>2</td>
                                                                                        <td>20000</td>
                                                                                        ...
                                                                                        <td>19/10/2014</td>
                                                                                        <td class="text-center"><a class='btn btn-success btn-xs' href="#">Aceptar</a> &nbsp<a class='btn btn-danger btn-xs' href="#">Rechazar</a>&nbsp<a class='btn btn-primary btn-xs' href="#">Detalles</a></td>
                                                                                    </tr>-->
                                            <tr class="warning">
                                                <td>3</td>
                                                <td>25000</td>
