<%-- 
    Document   : index
    Created on : 13/11/2014, 03:29:29 PM
    Author     : Salvadorjr
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                SAC <small> <spring:message code="departamentodeventas  "></spring:message>Departamento de Ventas</small>
                            </h1>
                            <ol class="breadcrumb">
                                <li class="active">
                                  <spring:message code="bienvenido "></spring:message>  Bienvenido
                                </li>
                            </ol>
                            <br>
                            <br>
                            ...
                            <div class="row">
                                <div class="col-md-offset-1 col-lg-4" align="right">
                                    <img src="../img/indexImg.jpg" class="img-rounded" width="700" height="400">
                                    <br>
                                    <br>
                                    <br>
                                    <br>
