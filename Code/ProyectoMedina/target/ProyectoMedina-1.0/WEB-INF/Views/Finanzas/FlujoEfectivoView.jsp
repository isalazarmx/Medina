                                ...
                                <div class="panel-body">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title text-left"><spring:message code="flujoEfectivo"/></h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                    ...
                                    <form action="ReporteFlujoEfectivoView" method="post">
                                        <div class="row">
                                            <input type="submit" class="btn btn-success active col-md-offset-11" onclick="return validarDropDownTwo('puno', 'pdos');" role="button" value=<spring:message code="aceptar"/> >
                                        </div>
                                    </form>      
