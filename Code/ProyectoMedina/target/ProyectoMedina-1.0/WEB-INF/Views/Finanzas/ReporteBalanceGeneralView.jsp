                                ...
                                <div class="panel-body">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title text-left"><spring:message code="balanceGeneral"/>Septiembre 2014</h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-offset-3 text-center">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <H4><strong><spring:message code="concepto"/></strong></H4>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <H4><strong><spring:message code="debe"/></strong></H4>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <H4><strong><spring:message code="haber"/></strong></H4>
                                                        </div>        
                                                    </div>
                                                    <br>
                                                    <!-- Primera fila -->
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><spring:message code="efectivo"/></H4>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><spring:message code="papeleria"/></H4>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2">
                                                            <div class="form-group input-group">
                                                                <span class="input-group-addon">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><spring:message code="mobiliario"/></H4>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2">
                                                            <div class="form-group input-group">
                                                                <span class="input-group-addon">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><spring:message code="capital"/></H4>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><spring:message code="retiros"/></H4>
                                                        </div>
                                                        <div class="col-md-2 col-md-offset-2 col-lg-2">
                                                            <div class="form-group input-group">
                                                                <span class="input-group-addon">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><spring:message code="cporpagar"/></H4>
                                                        </div>
                                                        <div class="col-md-2 col-md-offset-2 col-lg-2">
                                                            <div class="form-group input-group">
                                                                <span class="input-group-addon">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><spring:message code="ingresos"/></H4>
                                                        </div>
                                                        <div class="col-md-2 col-md-offset-2 col-lg-2">
                                                            <div class="form-group input-group">
                                                                <span class="input-group-addon">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><spring:message code="gporsueldo"/></H4>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2">
                                                            <div class="form-group input-group">
                                                                <span class="input-group-addon">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><spring:message code="gporagua"/></H4>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2">
                                                            <div class="form-group input-group">
                                                                <span class="input-group-addon">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><spring:message code="gporluz"/></H4>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2">
                                                            <div class="form-group input-group">
                                                                <span class="input-group-addon">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><spring:message code="gporgas"/></H4>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2">
                                                            <div class="form-group input-group">
                                                                <span class="input-group-addon">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 text-left">
                                                            <H4><strong><spring:message code="balance"/></strong></H4>
                                                        </div>
                                                        <div class="col-md-2 col-lg-2">
                                                            <div class="form-group input-group">
                                                                <span class="input-group-addon">
