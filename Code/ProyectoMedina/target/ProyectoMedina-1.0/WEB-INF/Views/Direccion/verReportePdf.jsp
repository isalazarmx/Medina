...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 align="left">Reporte</h3>
                                </div>
                                <div class="panel-body">
                                    <!--Pagina en General-->
                                    <!--Codigo Para panel 5 o menos inputs-->
                                    <object data="img/Reporte.pdf" name="visorPdf" width="1024" height="800" type="application/pdf">
                                    </object><!-- Visor de archivos PDF -->
        ...
        <!--<script src="js/jsDireccion.js" type="text/javascript"><script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script><!--NO TOCAR-->
