<%-- 
    ...
    Created on : 13/11/2014, 11:29:56 PM
    Author     : Carlos
--%>
                                    ...
                                    <div class="panel-body">
                                        <div class="col-lg-6 text-left">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group input-group">
                                                    <select id="departamentosLista" class="form-control selectpicker show-tick show-menu-arrow">
                                        ...
                                        <div class="col-lg-6 text-left">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group input-group">
                                                    <select id="disabledSelect" class="form-control selectpicker show-tick show-menu-arrow">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-lg-6 text-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="Raz&oacute;n Social" onkeypress="return soloTexto(event);" maxlength="40" required>
                                            </div>
                                            <h5>Sexo</h5>
                                            <div class="radio">
                                                <label>
