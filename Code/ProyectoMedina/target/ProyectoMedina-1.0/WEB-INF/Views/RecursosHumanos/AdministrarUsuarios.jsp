<%-- 
    ...
    Created on : 13/11/2014, 11:25:07 PM
    Author     : Carlos
--%>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">Detalles del usuario actual</h4>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" onclick="redirectModificarEmp()">Modificar</button>
