<%-- 
    Document   : BuscarClienteView
    Created on : 13/11/2014, 11:31:52 PM
    Author     : Behto
--%>
                        ...
                        <div class="col-lg-12 text-left">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 text-left">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="disabledInput" placeholder="<spring:message code="nombre"/>"  maxlength="50" onkeypress="return soloTexto(event);" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label><spring:message code="apellido_paterno"/></label>
                                                        <input class="form-control" id="disabledInput" placeholder="<spring:message code="apellido_paterno"/>"  maxlength="50" onkeypress="return soloTexto(event);" disabled>
                                                    </div> 
                                                    <div class="form-group">
                                                        <label><spring:message code="apellido_materno"/></label>
                                                        <input class="form-control" id="disabledInput" placeholder="<spring:message code="apellido_materno"/>"  maxlength="50" onkeypress="return soloTexto(event);" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label><spring:message code="direccion"/></label>
                                                        <input class="form-control" id="disabledInput" placeholder="direccion"  maxlength="50" disabled>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 text-left">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="Telefono" placeholder="codigo_postal"  minlength="5" maxlength="5" onkeypress="return soloNumeros(event);" disabled>
                                                    </div>	
                                                    <div class="form-group">
                                                        <label><spring:message code="telefono"/></label>
                                                        <input class="form-control" id="Telefono" placeholder="<spring:message code="telefono"/>"  minlength="10" maxlength="10" onkeypress="return soloNumeros(event);" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label><spring:message code="e-mail"/></label>
                                                        <input class="form-control" type="email" placeholder="<spring:message code="e-mail"/>"  maxlength="20" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label><spring:message code="fax"/></label>
                                                        <input class="form-control" id="Telefono" placeholder="<spring:message code="fax"/>"  minlength="10" maxlength="10" onkeypress="return soloNumeros(event);" disabled>
                                                    </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 text-left">
                                                    <div class="form-group">
                                                        <label><spring:message code="nombre"/></label>
                                                        <input class="form-control" placeholder="<spring:message code="nombre"/>"  maxlength="50" onkeypress="return soloTexto(event);" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label><spring:message code="razon_social"/></label>
                                                        <input class="form-control" placeholder="<spring:message code="razon_social"/>"  maxlength="50" onkeypress="return soloTexto(event);" disabled>
                                                    </div> 
                                                    <div class="form-group">
                                                        <label><spring:message code="rfc"/></label>
                                                        <input class="form-control" placeholder="<spring:message code="rfc"/>"  minlength="15" maxlength="15"  disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label><spring:message code="direccion"/></label>
                                                        <input class="form-control" placeholder="<spring:message code="direccion"/>"  maxlength="50"  disabled>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 text-left">
                                                    <div class="form-group">
                                                        <label><spring:message code="codigo_postal"/></label>
                                                        <input class="form-control" id="Telefono" placeholder="<spring:message code="codigo_postal"/>"  minlength="5" maxlength="5" onkeypress="return soloNumeros(event);" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="Telefono" placeholder="<spring:message code="telefono2"/>"  minlength="10" maxlength="10" onkeypress="return soloNumeros(event);" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label><spring:message code="telefono3"/></label>
                                                        <input class="form-control" id="Telefono" placeholder="<spring:message code="telefono3"/>"  minlength="10" maxlength="10" onkeypress="return soloNumeros(event);" disabled>
                                                    </div>
                                    ...
                                    <div align="right">
                                        <!-- <button type="submit" class="btn btn-success" onclick="onkeypress="return noFuncional();"('dropdown1')">Aceptar</button>-->
                                        <!-- <button type="submit" class="btn btn-success" onClick="return validar();">Aceptar</button>
