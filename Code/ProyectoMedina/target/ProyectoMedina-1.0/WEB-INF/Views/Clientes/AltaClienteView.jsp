<%-- 
    Document   : AltaClienteView
    Created on : 13/11/2014, 11:31:04 PM
    Author     : Behto
--%>
...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- CONTENIDO -->
            <div id="page-wrapper">
                <form onsubmit="return confirmarAltas();"> <!--- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"><spring:message code="bienvenido"/></h3>
                                            </div>
                                            <div class="panel-body">
                                                <div class="row">
                                                    <!-- ################################################################### -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 text-left">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="rfc"  placeholder="<spring:message code="rfc"/>" type="text" class="form-control" id="rfc" size="24" maxlength="15" onblur="ValidaRfc(this.value)" required/> 
                                                            <!--<input class="form-control" placeholder="R.F.C"  minlength="15" maxlength="15" required>-->
                                                        </div>
                                                        <div class="form-group">
                                                            <label ><spring:message code="direccion"/></label>
                                                            <input class="form-control" placeholder="<spring:message code="direccion"/>"  maxlength="50" required>
                                        ...
                                        <div align="right">
                                            <!-- <button type="submit" class="btn btn-success" onclick="return confirmarAltas();">Aceptar</button>-->
            ...
            <script type="text/javascript" src="${pageContext.request.contextPath}/resources/Clientes/jsClientes/jsClie.js"></script>
